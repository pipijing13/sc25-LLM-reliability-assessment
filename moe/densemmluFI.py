...
def save_detailed_results(results, filename="weight_bit_flip_detailed_results.json"):
    ...
    #except TypeError as e:
        ...
        # Print the type of object that cannot be serialized
...
def main():
    ...
    output_dir = "densemmluFI"
    os.makedirs(output_dir, exist_ok=True)

    # Load model and tokenizer
    print("Loading model and tokenizer...")
    model = lm_eval.models.huggingface.HFLM(pretrained="meta-llama/Llama-3.2-3B-Instruct", dtype=torch.bfloat16,
                                            device_map="cuda")

    # Define layer weights as in the original code
    layer_weights = {
        'self_attn.v_proj': 1,
        'self_attn.k_proj': 1,
        'self_attn.q_proj': 3,
    ...
    # Prepare evaluation
    task = "tinyMMLU"  # A single tinyMMLU task

    # Create results dictionary
    results = {
        "base_accuracy": None,
        "base_results_detail": None,  # Store detailed baseline results
        "bit_flip_trials": [],
    }
    ...
    # Store the baseline accuracy and detailed results
    ...
    for trial in range(num_trials):
        ...
        # Select a random bit position to flip (0-15 for float16)
        ...
        # Evaluate the model with the bit flip
        ...
        # Save individual trial results to separate file
    ...
    # Also save a summary version without the detailed evaluation results
    summary_results = {
